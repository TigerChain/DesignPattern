...
/**
 * @Description ExpandableListView 适配器
...
public class MyAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        if(convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.myexpandlistview_list_group_item, parent, false);
        }
        ...
        final ImageView expandedImage = convertView.findViewById(R.id.sample_activity_list_group_expanded_image);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        if(convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.myexpandlistview_list_child_item, parent, false);
        }

        final TextView text = convertView.findViewById(R.id.sample_activity_list_child_item_text);
